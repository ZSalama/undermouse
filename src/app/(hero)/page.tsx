	...
	return (
		<>
			<div className='bg-gray-200'>
				...
				{/* <div className='flex mt-20 px-5 md:px-8 bg-gray-200 lg:px-12 text-5xl font-bold mx-4 md:mx-auto md:w-2xl lg:w-4xl items-center justify-between'>
				...
				<div className='flex justify-center max-w-4xl mx-auto'>
					<Blog className='mb-20 mt-10 md:mt-10' />
				</div> */}
